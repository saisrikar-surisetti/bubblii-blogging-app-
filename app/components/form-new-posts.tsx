...
e.preventDefault();
  ...
  return (
    <div className=' rounded-3xl bg-fuchsia-400 border-8  mt-10 w-5/6  md:w-1/2 mx-auto my-auto text-center shadow-2xl'>
        <h1 className='text-fuchsia-700 font-mono text-xl mt-4'> Make a blog post bellow! </h1>
    ...
    type="submit" className='hover:bg-fuchsia-200 hover:cursor-pointer bg-fuchsia-100 text-fuchsia-400 text-xl rounded-md p-2 px-6 mt-1 mb-4'> POST  </button>
    </form>     
    </div>
  )
}
